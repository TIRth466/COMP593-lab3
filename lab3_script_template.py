...
def create_orders_dir(sales_csv):
    ...
    orders_directory_name=f'Orders_{date_of_today}'
    orders_directory_path=os.path.join(sales_directory,orders_directory_name)
...
def process_sales_data(sales_csv, orders_dir):
    ...
    # For each order ID:
        ...
        worksheet.set_column('F:G', 12 , format1)
